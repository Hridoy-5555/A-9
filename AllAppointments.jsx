...
const AllAppointments = () => {
  ...
  // Mock fetching data - In real app, fetch from MongoDB API
  useEffect(() => {
    const fetchDoctors = async () => {
      setLoading(true);
      // Placeholder data
      const data = [
        { id: "d1", name: "Dr. Ayesha Rahman", specialty: "Cardiologist", image: "https://images.unsplash.com/photo-1559839734-2b71ea197ec2?q=80&w=800", experience: "10 years", hospital: "Labaid Cardiac Hospital" },
        { id: "d2", name: "Dr. Imran Khan", specialty: "Pediatrician", image: "https://images.unsplash.com/photo-1612349317150-e413f6a5b16d?q=80&w=800", experience: "8 years", hospital: "Apollo Hospitals Dhaka" },
        { id: "d3", name: "Dr. Fatima Begum", specialty: "Dermatologist", image: "https://images.unsplash.com/photo-1594824476967-48c8b964273f?q=80&w=800", experience: "12 years", hospital: "Square Hospitals Ltd." },
      ];
      setDoctors(data);
      setLoading(false);
    };
